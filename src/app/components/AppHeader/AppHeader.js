  ...
  return `
    <header class=${styles.header}>
      <div class=${styles.container}>
          <a class=${styles.header__logo} href=${ROUTES.HOME.path}><img src=${bookstore} alt="BOOKSTORE"></a>
          ...
          <div class=${styles.header__actions}>
              <a href=${ROUTES.FAVORITES.path} class=${styles.icon}>
                  <img src=${heart} alt="favorite">
              </a>
              <a href=${ROUTES.CART.path} class=${styles.icon}>
                  <img src=${shoppingBag} alt="cart">
              </a>
              <a href=${ROUTES.PROFILE.path} class=${styles.icon}>
